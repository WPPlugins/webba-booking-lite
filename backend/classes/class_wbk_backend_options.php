...
class WBK_Backend_Options extends WBK_Backend_Component {
	...
	public function initSettings() {
    	...
    	// *** BEGIN  apppointment cancelation email
    	add_settings_field(
	        'wbk_email_adimn_appointment_cancel_status',
	        __( 'Send administrator an email (on cancelation)', 'wbk' ),
		...
		add_settings_field(
	        'wbk_email_adimn_appointment_cancel_subject',
	          __( 'Subject of an email to administrator (on cancelation)', 'wbk' ),
		...
		add_settings_field(
	        'wbk_email_adimn_appointment_cancel_message',
	          __( 'Message to administrator (on cancelation)', 'wbk' ),
    	...
    	// *** END  apppointment cancelation email
		add_settings_field(
	...
	public function render_email_admin_appointment_cancel_status() {
		...
		$html .= '<label for="wbk_email_adimn_appointment_cancel_status">' . __( 'Check if you\'d like to send administrator an email on appointment cancelation', 'wbk' ) . '</a>';
  		echo $html;
	}
	...
	public function validate_email_admin_appointment_cancel_status( $input ) {
        if ( $input != 'true' && $input != '' ) {
			$input = '';
			add_settings_error( 'wbk_email_adimn_appointment_cancel_status', 'wbk_email_adimn_appointment_cancel_status', __( 'Email (on cancelation) status updated', 'wbk' ), 'updated' );
		}
		return $input;
	}
	...
	public function render_email_customer_book_message() {
 		...
 		echo '<a disabled class="button wbk_email_editor_toggle">' . __( 'Toggle editor', 'wbk' ) . '</a><div class="wbk_email_editor_wrap" style="display:none;">';
	...
	// render email to admin message (cancelation)
	...
	// validate email toadmin message (cancelation)
	...
	public function render_email_customer_book_subject() {
		...
		$value = sanitize_text_field( $value );
		$html = '<input disabled type="text" id="wbk_email_customer_book_subject" name="wbk_email_customer_book_subject" value="'.$value.'" >';
	...
	public function render_email_customer_approve_subject() {
		...
		$value = sanitize_text_field( $value );
		$html = '<input disabled type="text" id="wbk_email_customer_approve_subject" name="wbk_email_customer_approve_subject" value="'.$value.'" >';
		$html .= '<p class="description">' . __( 'Available placeholders:'.' #appointment_time, #appointment_day, #service_name', 'wbk' ) . '</p>';
  		echo $html;
	}
	...
	// render admin email subject (on cancelation)
	public function render_email_admin_appointment_cancel_subject() {
		...
		$value = sanitize_text_field( $value );
		$html = '<input disabled type="text" id="wbk_email_adimn_appointment_cancel_subject" name="wbk_email_adimn_appointment_cancel_subject" value="'.$value.'" >';
		$html .= '<p class="description">' . __( 'Available placeholders:'.' #appointment_time, #appointment_day, #service_name', 'wbk' ) . '</p>';
  		echo $html;
	}
	// validate admin email subject (on cancelation)
	...
	public function render_email_secondary_book_subject() {
		...
		$value = sanitize_text_field( $value );
		$html = '<input disabled type="text" id="wbk_email_secondary_book_subject" name="wbk_email_secondary_book_subject" value="'.$value.'" >';
  		echo $html;
	}
	// validate email to secondary message
	...
	public function render_email_admin_daily_subject() {
		...
		$value = sanitize_text_field( $value );
		$html = '<input disabled type="text" id="wbk_email_admin_daily_subject" name="wbk_email_admin_daily_subject" value="'.$value.'" >';
  		echo $html;
	}
	// validate email to admin message
	...
	public function render_email_customer_daily_subject() {
		...
		$value = sanitize_text_field( $value );
		$html = '<input disabled type="text" id="wbk_email_customer_daily_subject" name="wbk_email_customer_daily_subject" value="'.$value.'" >';
		$html .= '<p class="description">' . __( 'Available placeholders:'.' #appointment_time, #appointment_day, #service_name', 'wbk' ) . '</p>';
  		echo $html;
	}
	// validate email to customer message
	...
	public function render_super_admin_email() {
		...
		$value = sanitize_text_field( $value );
		$html = '<input disabled type="text" id="wbk_super_admin_email" name="wbk_super_admin_email" value="'.$value.'" >';
  		echo $html;
	}
	...
	public function render_email_landing() {
		...
		$value = sanitize_text_field( $value );
		$html = '<input disabled type="text" id="wbk_email_landing" name="wbk_email_landing" value="'.$value.'" >';
	...
	public function render_email_landing_text() {
		...
		$value = sanitize_text_field( $value );
		$html = '<input disabled type="text" id="wbk_email_landing_text" name="wbk_email_landing_text" value="'.$value.'" >';
  		echo $html;
	}
	...
	public function render_pickadate_load() {
		...
		$html .= '<p class="description">' . __( 'Set "no" if there are plugins in your WordPress that using the pickadate date picker.', 'wbk' ) . '</p>';
  		echo $html;
	}
