...
class WBK_Frontend_Booking {
	...
	public function enqueueScripts() {
		if( $this->has_shortcode( 'webba_booking' ) ) {
			...
			$translation_array = array(
				...
				'checkout'  => str_replace( '#selected_count', '<span class="wbk_multi_selected_count"></span>', get_option( 'wbk_checkout_button_text', 'Checkout'  ) ),
	...
	private function has_shortcode_strong( $hortcode ){
